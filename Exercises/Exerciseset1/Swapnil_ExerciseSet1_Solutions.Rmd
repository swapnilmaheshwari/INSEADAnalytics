...
author: "Swapnil Maheshwari Exercise Set 1"
...
<br> 2. ```{r echo=TRUE, comment=NA, warning=FALSE, message=FALSE,results='asis',fig.align='center', fig.height=4,fig.width= 6, fig=TRUE}
