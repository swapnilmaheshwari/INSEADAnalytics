---
title: "Solution to Exercise Set 2: A $300 Billion Strategy"
author: "Swapnil Maheshwari"
...
**Your Answers here:**
<br> 1. 6 components explain more than 50% of the variance in this data.
<br> 2. The highest weights are 5yr T-Notes: 0.93, 10yr T-Notes: 0.93, Treasury Bonds: 0.86, 2 yr T-Note US: 0.85 and Canadian Bond: 0.79.
<br> 3. The first 10 components explain 62.61% of the variance and can be called principal components.
<br> 4. 
...
**Your Answers here:**
<br> 1. The code produces a list of moving averages and stores them in a matrix. Each of the data point indicates whether the future's return was positive or negative with a +/- vote. The strategy for the future is based on the signal from 2 days ago. 
<br> 2. The performance of the strategy is based on the window of moving average. Changing the moving average period will change the performance strategy as well.
